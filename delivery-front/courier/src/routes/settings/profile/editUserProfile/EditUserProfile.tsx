...
import {useRouterActions as useRouteCourierActions} from 'state/courier/hooks/UseActions';
...
const EditFields: React.FC<EditFieldsProps> = ({account}) => {
  ...
  const routerCourierAction = useRouteCourierActions();
      ...
      <View>
        <TouchableOpacity
          onPress={() => {
            ...
            setTimeout(() => routerCourierAction.navigateToProfile(), 100);
          }}
        >
          <LinearGradient
            start={{x: 0, y: 0}}
