...
export default abstract class IDishStore {
    ...
    abstract updateDish(id: string, imageId: string, name: string, description: string, weight: string, kal: string, ingredient: Ingredient[]): Promise<Dish>;
    abstract createDish(imageId: string, name: string, description: string, weight: string, kal: string, ingredient: Ingredient[]): Promise<Dish>;
