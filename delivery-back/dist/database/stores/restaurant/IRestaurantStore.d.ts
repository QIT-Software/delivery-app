...
export default abstract class IRestaurantStore {
    ...
    abstract createRestaurant(userId: string, imageId: string, title: string, description: string, address: Address, cuisines: Cuisine[]): Promise<void>;
    abstract updateRestaurant(id: string, imageId: string, title: string, description: string, address: Address, cuisines: Cuisine[]): Promise<Restaurant>;
