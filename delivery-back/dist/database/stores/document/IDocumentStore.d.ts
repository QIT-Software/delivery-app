...
export default abstract class IDocumentStore {
    ...
    abstract addDocument(revisionId: ID, fileId: {
        id: ID;
    ...
    abstract requestDocumentsRevisionVerification(revisionId: ID, status: DocumentsRevisionStatus.VerificationRequested): Promise<void>;
    abstract evaluateRevision(revisionId: ID, status: DocumentsRevisionStatus.Approved | DocumentsRevisionStatus.ChangesRequested | DocumentsRevisionStatus.Rejected, comment: string): Promise<void>;
