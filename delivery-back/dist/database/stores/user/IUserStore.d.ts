...
export default abstract class IUserStore {
    ...
    abstract updateClientInformation(id: string, name: string, email: string, phoneNumber: string): Promise<void>;
    abstract updateCourierInformation(id: string, name: string, email: string, phoneNumber: string): Promise<void>;
