...
export default abstract class ISetStore {
    ...
    abstract updateSet(id: string, name: string, imageId: string, priceCents: number, cuisineId: string, dishes: Dish[], statuses: Status[]): Promise<Set>;
    abstract createSet(name: string, imageId: string, priceCents: number, cuisineId: string, dishes: Dish[], statuses: Status[]): Promise<void>;
