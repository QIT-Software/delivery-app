...
export default abstract class IUserManager {
    abstract updateClientInformation(id: ID, name: string, email: string, phoneNumber: string): Promise<void>;
    abstract updateCourierInformation(id: ID, name: string, email: string, phoneNumber: string): Promise<void>;
