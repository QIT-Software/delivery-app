...
export default abstract class ISetManager {
    ...
    abstract updateSet(id: string, name: string, imageId: string, priceCents: string, cuisineId: string, dishes: string[], statuses: string[]): Promise<Set>;
    abstract createSet(name: string, imageId: string, priceCents: string, cuisineId: string, dishes: string[], statuses: string[]): Promise<void>;
