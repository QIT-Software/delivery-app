import { Document, DocumentGroup, DocumentsRevision, EvaluateDocumentsRevisionType } from 'entities/Document';
...
export default abstract class IDocumentManager {
    ...
    abstract addDocument(userId: ID, fileId: ID, group: DocumentGroup, appType: AppType): Promise<Document>;
    ...
    abstract evaluateRevision(courierId: ID, type: EvaluateDocumentsRevisionType, comment: string): Promise<void>;
}
