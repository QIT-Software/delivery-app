...
let Address = (() => {
    let Address = class Address {
        constructor(id, placeId, lat, lng, description, entrance, floor, apartment, date) {
            this.id = id;
    ...
    Address = __decorate([
        ...
        __metadata("design:paramtypes", [String, String, Number, Number, String, String, String, String, Date])
    ], Address);
    return Address;
})();
