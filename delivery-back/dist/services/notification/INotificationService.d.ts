...
export default abstract class INotificationService {
    ...
    abstract sendOrderAccepted(order: Order, type: 'courier', courier: {
        id: ID;
    }): Promise<void>;
    abstract sendNewOrderCreated(order: Order): Promise<void>;
    abstract sendMarkOrder(order: Order, type: 'client' | 'courier' | 'restaurant'): Promise<void>;
    abstract sendDocumentsRevisionEvaluated(courier: Courier, status: DocumentsRevisionStatus, comment: string): Promise<void>;
